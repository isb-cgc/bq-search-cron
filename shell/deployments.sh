...
if [ "${DO_FUNCTION_DEPLOY}" == "TRUE" ]; then
    ...
    --set-env-vars BQ_GCS_PROJECT=${BQ_GCS_PROJECT},STATIC_BUCKET_NAME=${STATIC_BUCKET_NAME},METADATA_FILE_PATH=${METADATA_FILE_PATH},FILTERS_FILE_PATH=${FILTERS_FILE_PATH},JOIN_CSV_TO_JSON=${JOIN_CSV_TO_JSON},JOINS_CSV_FILE_PATH=${JOINS_CSV_FILE_PATH},JOINS_JSON_FILE_PATH=${JOINS_JSON_FILE_PATH},BQ_PROJECT_NAMES=${BQ_PROJECT_NAMES},BQ_ECO_SCAN_LABELS_ONLY=${BQ_ECO_SCAN_LABELS_ONLY},BQ_HANDLE_VIEWS=${BQ_HANDLE_VIEWS}
fi
