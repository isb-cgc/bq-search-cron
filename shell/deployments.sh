...
if [ "${DO_FUNCTION_DEPLOY}" == "TRUE" ]; then
    ...
    --cpu ${FUNCTION_CPU} \
    --set-env-vars METADATA_TABLE_DATASET_ID=${METADATA_TABLE_DATASET_ID},METADATA_TABLE_PROJECT_ID=${METADATA_TABLE_PROJECT_ID},STATIC_BUCKET_NAME=${STATIC_BUCKET_NAME},METADATA_FILE_PATH=${METADATA_FILE_PATH},FILTERS_FILE_PATH=${FILTERS_FILE_PATH},JOIN_CSV_TO_JSON=${JOIN_CSV_TO_JSON},JOINS_CSV_FILE_PATH=${JOINS_CSV_FILE_PATH},JOINS_JSON_FILE_PATH=${JOINS_JSON_FILE_PATH},BQ_PROJECT_NAMES=${BQ_PROJECT_NAMES},BQ_ECO_SCAN_LABELS_ONLY=${BQ_ECO_SCAN_LABELS_ONLY},BQ_BUILD_VERSION_JSON=${BQ_BUILD_VERSION_JSON},MARKED_TABLE_MAP_FILE_PATH=${MARKED_TABLE_MAP_FILE_PATH},VERSIONS_JSON_FILE_PATH=${VERSIONS_JSON_FILE_PATH},READ_PUBLIC_ONLY=${READ_PUBLIC_ONLY}
fi
